...
exports.up = function(knex, Promise) {
    ...
    .createTable('recipeIngredientsMap', (rIM) => {
        rIM.integer('recipeId').references('recipes.id');
        rIM.integer('ingredientId').references('ingredients.id');
        rIM.integer('quantity').notNullable();
    })
