  ...
  return knex('recipes').del()
    .then(function () {
      ...
      return knex('recipes').insert([
        ...
        {recipe_name: 'cheesy-tacos', directions: 'boil shell for 10 mins in oil, let stand 5 mins, add alot of cheese, add meat cooked', dish_id: 2},
        {recipe_name: 'regular-tacos', directions: 'boil shell for 10 mins in oil, let stand 5 mins, add some cheese, add meat cooked', dish_id: 2},
      ]);
    });
};
